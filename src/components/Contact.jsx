...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16' >
            ...
            <form action="https://getform.io/f/ebf1bc99-e366-4528-bba9-19ce56a284c6" method="post" encType='multipart/form-data'>
                <div className='text-left grid md:grid-cols-2 gap-4 w-full py-2'>
